...
\resizebox{\columnwidth}{!}{%
    ...
    \toprule
    \textbf{ID} & \textbf{Matrix Name} & \textbf{Rows ($M$)} & \textbf{Columns ($N$)} & \textbf{NNZ} & \textbf{Avg. NNZ} & \textbf{Dev. Std.} & \textbf{Structural Domain / Description} \\
    \midrule
...
\resizebox{\columnwidth}{!}{%
    ...
    \toprule
    \textbf{Target GPUs} & \textbf{Matrix Name} & \textbf{Rows ($M$)} & \textbf{Columns ($N$)} & \textbf{Total NNZ} & \textbf{Avg. D} & \textbf{Structural Profile} \\
    \midrule
