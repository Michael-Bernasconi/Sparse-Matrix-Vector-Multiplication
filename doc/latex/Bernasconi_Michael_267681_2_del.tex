...
\resizebox{\columnwidth}{!}{%
    ...
    \toprule
    Target GPUs & Matrix Name & Rows ($M$) & Columns ($N$) & Total NNZ & Avg. D & Structural Profile \\
    \midrule
